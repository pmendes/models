...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_1">
    ...
    <Comment>
      <body xmlns="http://www.w3.org/1999/xhtml"><h1>Michaelis-Menten enzyme kinetics</h1>
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=Michaelis-Menten enzyme kinetics" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Vector=Compartments[compartment]" value="1" type="Compartment" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Vector=Compartments[compartment],Vector=Metabolites[P]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Vector=Compartments[compartment],Vector=Metabolites[S]" value="6.0221408570000002e+23" type="Species" simulationType="reactions"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Vector=Reactions[Enzyme catalysis]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Vector=Reactions[Enzyme catalysis],ParameterGroup=Parameters,Parameter=Km" value="0.10000000000000001" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Vector=Reactions[Enzyme catalysis],ParameterGroup=Parameters,Parameter=V" value="0.10000000000000001" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
        </ModelParameterGroup>
      </ModelParameterSet>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Object" type="cn" value="CN=Root,Model=Michaelis-Menten enzyme kinetics,Vector=Compartments[compartment],Vector=Metabolites[S],Reference=InitialConcentration"/>
  ...
  <ListOfReports>
    ...
    <Report key="Report_10" name="Time, Concentrations, Volumes, and Global Quantity Values" taskType="timeCourse" separator="&#x09;" precision="6">
      ...
      <Table printTitle="1">
        <Object cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Reference=Time"/>
        <Object cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Vector=Compartments[compartment],Vector=Metabolites[P],Reference=Concentration"/>
        <Object cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Vector=Compartments[compartment],Vector=Metabolites[S],Reference=Concentration"/>
        <Object cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Vector=Compartments[compartment],Vector=Metabolites[Inhibitor],Reference=Concentration"/>
      </Table>
    </Report>
  </ListOfReports>
  <ListOfPlots>
    <PlotSpecification name="Rate of reaction" type="Plot2D" active="1" taskTypes="Time-Course">
      ...
      <ListOfPlotItems>
        <PlotItem name="rate" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Vector=Reactions[Enzyme catalysis],Reference=Flux"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
    <PlotSpecification name="Progress of reaction (time course)" type="Plot2D" active="1" taskTypes="Time-Course">
      ...
      <ListOfPlotItems>
        <PlotItem name="[P]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Vector=Compartments[compartment],Vector=Metabolites[P],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
    <PlotSpecification name="Initial rate kinetics" type="Plot2D" active="1" taskTypes="Scan">
      ...
      <ListOfPlotItems>
        <PlotItem name="initial rate" type="Curve2D">
          ...
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Vector=Compartments[compartment],Vector=Metabolites[S],Reference=InitialConcentration"/>
            <ChannelSpec cn="CN=Root,Model=Michaelis-Menten enzyme kinetics,Vector=Reactions[Enzyme catalysis],Reference=Flux"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
